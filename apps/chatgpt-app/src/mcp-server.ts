...
export function createQFerryMcpServer(): McpServer {
  ...
  server.registerTool(
    "execute_cleanup",
    {
      ...
      description: "Use this only after confirm_cleanup_plan has confirmed a plan generated by this QFerry MCP server instance. Only move actions are currently supported.",
      inputSchema: {
        operationPlanId: z.string(),
      },
